...
<div id="searchByName" class="tabPages">
    <form method="POST" action="/neighbors-results1" class="tabForm">
<span class="inputLine">
    <h1 class="tabText">How many neighbors would you like to search for?: </h1>
<textarea name="numNeighbors" rows="1" class="num-input"></textarea></span>
...
<div id="searchByCoordinates" class="tabPages">
    <form method="POST" action="/neighbors-results2" class="tabForm">
        <span class="inputLine">
        <h1 class="tabText">How many neighbors would you like to search for?: </h1>
        <textarea name="numNeighbors" rows="1" class="num-input"></textarea></span>
